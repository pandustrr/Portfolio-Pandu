...
export default function SplashCursor({
  ...
  DENSITY_DISSIPATION = 4.0, // Faster disappearance
  VELOCITY_DISSIPATION = 2.5,
  PRESSURE = 0.1,
  PRESSURE_ITERATIONS = 14, // Lower iterations
  CURL = 2, // Less complex fluid
  SPLAT_RADIUS = 0.15,
  SPLAT_FORCE = 4000,
  SHADING = false, // Disable shading for better performance
  ...
  useEffect(() => {
    ...
    function scaleByPixelRatio(input: number) {
      const pixelRatio = (window.devicePixelRatio || 1) * 0.75; // Lower internal resolution
